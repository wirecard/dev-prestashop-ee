...
use WirecardEE\Prestashop\Models\PaymentPaylib;

class PaymentPaylibTest extends PHPUnit_Framework_TestCase
{
    private $payment;
    ...
    public function setUp()
    {
        ...
        $this->paymentModule = $this->getMockBuilder(\WirecardPaymentGateway::class)
            ...
            ->getMock();
        $this->payment = new PaymentPaylib($this->paymentModule);
    ...
    {
        /** @var Wirecard\PaymentSdk\Transaction\PaylibTransaction $actual */
