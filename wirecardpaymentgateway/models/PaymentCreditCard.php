        ...
        return array(
            ...
            'fields' => array(
                array(
                    ...
                    'label' => 'Enable',
                    'type' => 'onoff',
                    'doc' => $this->translate('ccard_enable_doc'),
                    'default' => 0,
                ),
                array(
                    'name' => 'title',
                ...
                array(
                    ...
                    'label'    => $this->translate('ccard_3d_merchant_id_doc'),
                    'type'     => 'text',
                ...
                array(
                    'name' => 'three_d_secret',
                    'label'       => $this->translate('ccard_3d_secret_key_doc'),
                    'type'        => 'text',
                    'default'     => 'dbc5a498-9a66-43b9-bf1d-a618dd399684',
                    'required' => true,
                ),
                array(
                    'name' => 'ssl_max_limit',
                    'label'       => $this->translate('ccard_non_3d_max_limit_doc'),
                    'type'        => 'text',
                    'default'     => '300.0',
                    'required' => true,
                ),
                array(
                    ...
                    'label'       => $this->translate('ccard_3d_min_limit_doc'),
                    'type'        => 'text',
                    'default'     => '100.0',
                    'required' => true,
                ),
                ...
                array(
                    ...
                    'type' => 'linkbutton',
                    'required' => false,
                    'buttonText' => $this->translate('ccard_test_config_butoon_doc'),
                    'id' => 'creditcardConfig',
                    'method' => 'creditcard',
                    'send' => array(
